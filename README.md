...
版本：v0.8.0 [链接](https://serco-chen.github.io/how-to-lose-money-in-a-shares)
...
当9个章节全部撰写完毕后，并且总体填补完成后，本书将会进入1.0.0-rc序列的版本号，主要工作为撰写结束语、免责声明和修改润色全书的章节内容，以及数据和事实部分的勘误。
